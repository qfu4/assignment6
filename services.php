...
<head>
    ...
    <title>Giodme Personal Website | Services</title>
    ...
    <main class="container white-background">
        ...
        <section class="service-grid">
            ...
            <aside>
                ...
                <div class="price-box">$35 PER HOUR</div>
            </aside>
        </section>
        ...
        <section class="service-grid">
            ...
            <aside>
                ...
                <div class="price-box">$20 PER SESSION</div>
            </aside>
        </section>

        <footer class="call-to-action">
            <div class="small-title">STAY UPDATED</div>
            <a href="newsletter.php">SUBSCRIBE TO MY NEWSLETTER</a>
        </footer>
    </main>
